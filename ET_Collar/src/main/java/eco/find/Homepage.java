    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (id == R.id.map) {
                    if(sp_value==null){
                        Toast.makeText(getApplicationContext(),"Please select valid device",Toast.LENGTH_SHORT).show();
                    }else {
...
//        }
//        else{
//            Toast.makeText(Homepage.this, "Please enter a valid device", Toast.LENGTH_LONG).show();
//        }
    }
    ...
    ArrayList<String> hdList;
    public boolean checkIfHdExist(String macAddress){
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                hdList.clear();
              //  if (dataSnapshot != null && dataSnapshot.getValue() != null) {
                    for (DataSnapshot rd : dataSnapshot.child("AnimalData/HdList").getChildren()) {
                        //   String hardId= rd.getValue(String.class);
                        hdList.add(rd.getValue().toString());
                        Toast.makeText(getApplicationContext(), " successfully", Toast.LENGTH_SHORT);
                    }
                    Log.d("Arr..2ay",ar.toString());
            //    }
        ...
        return(hdList.contains(macAddress));
        //return true;
    }
